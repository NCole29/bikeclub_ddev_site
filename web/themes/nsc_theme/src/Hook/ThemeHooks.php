...
/**
 * Contains hook implementations for NscTheme.
 */
final class ThemeHooks {
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['nsc_theme_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('nsc_theme');
  }
  ...
  public function preprocessParagraph(array &$variables): void {
    ...
    switch($ptype) {
      case 'banner':
        $variables['overlay_bg']  = theme_get_setting('bikeclub_banner_bg', 'nsc_theme');
        $variables['button_tx']   = theme_get_setting('bikeclub_banner_tx_bt', 'nsc_theme');
        $variables['button_tx_h'] = theme_get_setting('bikeclub_banner_tx_bt_h', 'nsc_theme');
        $variables['button_bg']   = theme_get_setting('bikeclub_banner_bg_bt', 'nsc_theme');
        $variables['button_bg_h'] = theme_get_setting('bikeclub_banner_bg_bt_h', 'nsc_theme');
      break;

      case 'callout':  
        $variables['border_color'] = theme_get_setting('bikeclub_callout_br', 'nsc_theme');
        $variables['shade_color']  = theme_get_setting('bikeclub_callout_bg', 'nsc_theme');
        $variables['button_bg']    = theme_get_setting('bikeclub_callout_bt_bg', 'nsc_theme');
        $variables['button_tx']    = theme_get_setting('bikeclub_callout_bt_tx', 'nsc_theme');
      break;

      case 'card':
      // kint($paragraph->field_shaded_background);
       //die;
      break;
    }
  }
