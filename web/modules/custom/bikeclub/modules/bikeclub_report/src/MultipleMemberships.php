...
class MultipleMemberships {
  ...
  public function getMultiples() {   
    ...
    $footer = "<p class='footer'>Note: This report is not created by Views. It requires sequential queries and is produced by bikeclub_report/src/MultipleMemberships.php.</p></p><p><hr></p>";
